...
<ENV>$setu=/home/setu/ilmtmodules/modules/transfergrammar/transfergrammar-2.4.4/setu
<ENV>$src=$setu/src
<ENV>$bin=$setu/bin
...
# Prunning 
1	transfergrammar		$setu/bin/sl/transfergrammar/transfergrammar.sh	dep=<START>	intype=1	lang=sh
